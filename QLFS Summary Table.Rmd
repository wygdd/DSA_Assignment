...
cry01table$Labels <- c('Does not apply','No answer','India','Republic of Ireland','Pakistan','Poland','England','Northern Ireland','Scotland','Wales','UK, Britain (Did not know country)','Other')
colnames(cry01table) <- c('Country of Birth','Count','Lables')
kable(cry01table)
```
